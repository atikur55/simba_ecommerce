      ...
      <div class="login-wrapper wd-300 wd-xs-400 pd-25 pd-xs-40 bg-white">
        ...
        <form  action="{{ route('register') }}" method="post">
          ...
          <div class="form-group">
            ...
            <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password" placeholder="Your Confirm Password">
          </div><!-- form-group -->
          <div class="form-group tx-12">By clicking the Sign Up button below, you agreed to our privacy policy and terms of use of our website.</div>
          <button type="submit" class="btn btn-info btn-block">Sign Up</button><br>
          <div class="form-group text-center">
              <a href="#" class="btn btn-dark" style="text-decoration: none;">Register with github</a>
          </div>
        </form>
