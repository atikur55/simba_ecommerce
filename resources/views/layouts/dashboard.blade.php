...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><!-- <i class="icon ion-android-star-outline"></i> starlight --><img src="{{asset('dashboard_assets/img/AtikShop-logo.jpg')}}" alt="" width="220px" height="60px"></a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <a href="{{url('addfaq')}}" class="sl-menu-link @yield('addfaq')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-email-outline tx-24"></i>
            <span class="menu-item-label">Add Faq</span>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <a href="{{route('role.manager')}}" class="sl-menu-link @yield('Role Management')">
          <div class="sl-menu-item">
            <i class="menu-item-icon icon ion-ios-email-outline tx-24"></i>
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-200">
              <ul class="list-unstyled user-profile-nav">
                <li><a href="{{url('/')}}"><i class="icon ion-ios-person-outline"></i> Go Home Page</a></li>
