                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-2 col-sm-5 col-4">
                        <ul class="search-cart-wrapper d-flex">
                            ...
                            <li>
                                <a href="javascript:void(0);"><i class="flaticon-shop"></i> <span>{{total_cart()}}</span></a>
                                <ul class="cart-wrap dropdown_style">
                                     @php
                                        $subtotal = 0;
                                    @endphp
                                    ...
                                    <li class="cart-items">
                                        <div class="cart-img">
                                            <img src="{{asset('uploads/product')}}/{{$cart->connect_to_product_table->product_thumbnail_photo}}" alt="" width="50px">
                                        </div>
                                        <div class="cart-content">
                                            <a href="cart.html">{{$cart->connect_to_product_table->product_name}}</a>
                                            <span>QTY : {{$cart->amount}}</span>
                                            <p>${{$cart->connect_to_product_table->product_price}}</p>
                                            <a href="{{url('delete/cart')}}/{{$cart->id}}"><i class="fa fa-times"></i></a>
                                        </div>
                                    @php
                                        $subtotal = $subtotal+$cart->connect_to_product_table->product_price*$cart->amount;
                                    @endphp
                                    </li>
                                    @endforeach
                                   
                                    
                                    <li>Subtotol: <span class="pull-right">${{$subtotal}}
